...
public class WMSComplexTypes {
			...
			for (int i = 0; i < value.length; i++) {
				if (sameName(elems[0], value[i])) {
					...
					for (int ii = 0; ii < stringValues.length; ii++) {
						formatStrings.add(stringValues[ii]);
					}
				}

				if (sameName(elems[1], value[i])) {
					operationType = (org.geotools.data.ows.OperationType) value[i]
							.getValue();
				}
			}
	...
	protected static class _WMT_MS_CapabilitiesType extends WMSComplexType {
		 ...
		 * 
		 * @see
		 * org.geotools.xml.schema.Type#canEncode(org.geotools.xml.schema.Element
		 ...
		 * 
		 * @see
		 * org.geotools.xml.schema.Type#encode(org.geotools.xml.schema.Element,
	...
	protected static class _ServiceType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				...
				new WMSElement("ContactInformation",
						_ContactInformationType.getInstance(), 0, 1),
				new WMSElement("Fees", XSISimpleTypes.String.getInstance(), 0,
						1),
				new WMSElement("AccessConstraints",
						XSISimpleTypes.String.getInstance(), 0, 1),
				new WMSElement("LayerLimit",
						XSISimpleTypes.PositiveInteger.getInstance(), 0, 1),
				new WMSElement("MaxWidth",
						XSISimpleTypes.PositiveInteger.getInstance(), 0, 1),
				new WMSElement("MaxHeight",
						XSISimpleTypes.PositiveInteger.getInstance(), 0, 1),
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				...
				if (sameName(elems[5], value[i])) {
					ResponsiblePartyImpl contactInfo = (ResponsiblePartyImpl) value[i]
							.getValue();
	...
	protected static class _ContactInformationType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				...
				new WMSElement("ContactPosition",
						XSISimpleTypes.String.getInstance(), 0, 1),
				new WMSElement("ContactAddress",
						_ContactAddressType.getInstance(), 0, 1),
				new WMSElement("ContactVoiceTelephone",
						XSISimpleTypes.String.getInstance(), 0, 1),
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				...
				if (sameName(elems[1], value[i])) {
					...
					contactPerson
							.setPositionName(new SimpleInternationalString(
									positionName));
				}
				...
				if (sameName(elems[3], value[i])) {
					Collection voices = Collections.singleton(value[i]
							.getValue());
					if (telephone == null) {
	...
	protected static class _ContactPersonPrimaryType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				new WMSElement("ContactPerson",
						XSISimpleTypes.String.getInstance()),
				new WMSElement("ContactOrganization",
						XSISimpleTypes.String.getInstance()) };
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				...
				if (sameName(elems[3], value[i])) {
					...
					address.setAdministrativeArea(new SimpleInternationalString(
							state));
				}
	...
	protected static class _UserDefinedSymbolizationType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] { new WMSElement(
				"SupportedSLDVersion", XSISimpleTypes.String.getInstance(), 0,
				Integer.MAX_VALUE) };
	...
	protected static class _RequestType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				...
				new WMSElement("_ExtendedOperation",
						OperationType.getInstance(), 0, Integer.MAX_VALUE),
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				...
				if (sameName(elems[1], value[i])
					...
					request.setGetMap((org.geotools.data.ows.OperationType) value[i]
							.getValue());
				}
				...
				if (sameName(elems[5], value[i])) {
					request.setGetStyles((org.geotools.data.ows.OperationType) value[i]
							.getValue());
				}

				if (sameName(elems[6], value[i])) {
					request.setPutStyles((org.geotools.data.ows.OperationType) value[i]
							.getValue());
				}
	...
	protected static class _LayerType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				...
				new WMSElement("DataURL", _DataURLType.getInstance(), 0,
						Integer.MAX_VALUE),
				new WMSElement("FeatureListURL",
						_FeatureListURLType.getInstance(), 0, Integer.MAX_VALUE),
				new WMSElement("Style", _StyleType.getInstance(), 0,
						Integer.MAX_VALUE), // 15
				new WMSElement("MinScaleDenominator",
						XSISimpleTypes.Double.getInstance(), 0, 1),
				new WMSElement("MaxScaleDenominator",
						XSISimpleTypes.Double.getInstance(), 0, 1),
				new WMSElement("Layer", _LayerType.getInstance(), 0,
						Integer.MAX_VALUE),
				new WMSElement("SRS", XSISimpleTypes.String.getInstance(), 0,
						Integer.MAX_VALUE),
				new WMSElement("LatLonBoundingBox",
						_LatLonBoundingBoxType.getInstance(), 0, 1), // 20
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				...
				if (sameName(elems[8], value[i])) {
					...
					// NOTE: dim might be null here, because at this point a
					// sublayer without
					// dimension tags may not yet have inherited parent
					// dimensions.
			...
			layer.setChildren((Layer[]) childLayers
					.toArray(new Layer[childLayers.size()]));
	...
	protected static class _EX_GeographicBoundingBoxType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				new WMSElement("westBoundLongitude",
						LongitudeType.getInstance()),
				new WMSElement("eastBoundLongitude",
						LongitudeType.getInstance()),
	...
	protected static class _DimensionType extends WMSComplexType {
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			// We delegate to _ExtentType to fetch properties and value since
			// document structure
			// differs between WMS Spec. 1.1.1 and 1.3.0
			Extent ext = (Extent) _ExtentType.instance.getValue(element, value,
					attrs, hints);
			if (!ext.isEmpty()) {
	...
	protected static class _ExtentType extends WMSComplexType {
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			boolean multipleValues = "1".equals(attrs
					.getValue("multipleValues"));
			...
			return new Extent(name, defaultValue, multipleValues, nearestValue,
					extractedValue);
		}
	...
	protected static class _AttributionType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				new WMSElement("Title", XSISimpleTypes.String.getInstance(), 0,
						1),
				new WMSElement("OnlineResource",
						_OnlineResourceType.getInstance(), 0, 1),
	...
	protected static class _MetadataURLType extends WMSComplexType {
		...
		private static Attribute[] attrs = new Attribute[] { new WMSAttribute(
				null, "type", WMSSchema.NAMESPACE,
				XSISimpleTypes.NMTOKEN.getInstance(), Attribute.REQUIRED, null,
				null, false) };
	...
	protected static class _IdentifierType extends WMSComplexType {
		...
		private static Attribute[] attrs = new Attribute[] { new WMSAttribute(
				null, "authority", WMSSchema.NAMESPACE,
				XSISimpleTypes.String.getInstance(), Attribute.REQUIRED, null,
				null, false) };
	...
	protected static class _StyleType extends WMSComplexType {
		...
		private static Element[] elems = new Element[] {
				...
				new WMSElement("LegendURL", _LegendURLType.getInstance(), 0,
						Integer.MAX_VALUE),
				new WMSElement("StyleSheetURL",
						_StyleSheetURLType.getInstance(), 0, 1),
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				...
				if (sameName(elems[3], value[i])) {
					legendURLS.add(value[i].getValue());
				}
	...
	protected static class _OnlineResourceType extends WMSComplexType {
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			href = href != null ? href : attrs.getValue(
					XLinkSchema.NAMESPACE.toString(), "href");
			try {
				return new URL(href);
			} catch (MalformedURLException e) {
				e.printStackTrace();
	...
	protected static class _WMTException extends WMSComplexType {
		...
		private static Attribute[] attrs = new Attribute[] { new WMSAttribute(
				"version", XSISimpleTypes.String.getInstance()) };
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			return new ServiceException(
					(String) value[value.length - 1].getValue(), null);
		}
	...
	protected static class _ServiceExceptionReport extends WMSComplexType {
		...
		private static Element[] elems = new Element[] { new WMSElement(
				"ServiceException", _ServiceException.getInstance(), 0,
				Integer.MAX_VALUE) };
		...
		public Object getValue(Element element, ElementValue[] value,
			...
			for (int i = 0; i < value.length; i++) {
				ServiceException exception = (ServiceException) value[i]
						.getValue();
				if (exception.getCode() != null
						&& exception.getCode().length() != 0) {
					codes.add(exception);
				} else {
