...
public class WMSClientServlet extends AbstractWxSServlet {
	...
	private volatile Cache<String, CacheImage, BufferedImage> legendCache;

	/** cache voor voorgrond WMS afbeeldingen. */
	private volatile Cache<BboxLayerCacheKey, CacheImage, BufferedImage> fgWMSCache;

	/** cache voor feature info. */
	private volatile Cache<BboxLayerCacheKey, CachableString, String> featInfoCache;
