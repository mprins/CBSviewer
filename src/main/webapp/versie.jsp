...
<jsp:scriptlet>/* info uitlezen/ophalen uit de manifest */
			...
			org.slf4j.Logger logger = org.slf4j.LoggerFactory
					.getLogger("nl.mineleni.cbsviewer");</jsp:scriptlet>
<head>
...
<body>
	...
	<br /> OpenLayers versie:
	<jsp:expression>atts.getValue("OpenLayers-Version")</jsp:expression>
	<hr />
	...
	(<jsp:expression>request.getLocalName()</jsp:expression>) en is
	benaderd vanaf:
	<jsp:expression>request.getRemoteAddr()</jsp:expression>:<jsp:expression>request.getRemotePort()</jsp:expression>
	(<jsp:expression>request.getRemoteHost()</jsp:expression>) op
	<jsp:expression>new Date()</jsp:expression>
	<br /> Server info:
	<jsp:expression>getServletContext().getServerInfo()</jsp:expression>
	<br /> Java Servlet API
	<jsp:expression>getServletContext().getMajorVersion()</jsp:expression>.<jsp:expression>getServletContext().getMinorVersion()</jsp:expression>
