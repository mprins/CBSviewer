...
<body>
	...
	<h2>De verschillende afgebeelde kaartlagen zijn in hun geheel te downloaden.</h2>
	<p>De kaartlagen bestaan uit geometrie van de vlakken en bijbehorende statistieken. De geometrie wordt geleverd in ESRI&#0153;-shapeformaat.</p>

	<table class="download">
	  <tr>
		<th colspan="2">Te downloaden kaarten:</th>
	  </tr>
	  <tr class="yellow"> 
		<td>Kaartlaag</td>
		<td>Bestandstype</td>
