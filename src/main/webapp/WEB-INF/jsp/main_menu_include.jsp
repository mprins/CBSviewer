										...
										<div class="menuAccordionContent">
											<ul class="navleft">
													...
													<li><a href="#">Bevolkingsdichtheid<span><fmt:message key="KEY_TOOLTIP2" /></span></a>
														<ul class="submenu">
															<li>Gemeente<br/><a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'gemeenten2012_bevolkingsdichtheid_inwoners_per_km2')}" name="gemeenten2012_bevolkingsdichtheid_inwoners_per_km2">2012</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'gemeenten2011_bevolkingsdichtheid_inwoners_per_km2')}" name="gemeenten2011_bevolkingsdichtheid_inwoners_per_km2">2011</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'gemeenten2010_bevolkingsdichtheid_inwoners_per_km2')}" name="gemeenten2010_bevolkingsdichtheid_inwoners_per_km2">2010</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'gemeenten2009_bevolkingsdichtheid_inwoners_per_km2')}" name="gemeenten2009_bevolkingsdichtheid_inwoners_per_km2">2009</a></li>
															<li>Wijk<br/><a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'wijken2012_bevolkingsdichtheid_inwoners_per_km2')}"  name="wijken2012_bevolkingsdichtheid_inwoners_per_km2">2012</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'wijken2011_bevolkingsdichtheid_inwoners_per_km2')}" name="wijken2011_bevolkingsdichtheid_inwoners_per_km2">2011</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'wijken2010_bevolkingsdichtheid_inwoners_per_km2')}" name="wijken2010_bevolkingsdichtheid_inwoners_per_km2">2010</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'wijken2009_bevolkingsdichtheid_inwoners_per_km2')}" name="wijken2009_bevolkingsdichtheid_inwoners_per_km2">2009</a></li>
															<li>Buurt<br/><a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'buurten2012_bevolkingsdichtheid_inwoners_per_km2')}" name="buurten2012_bevolkingsdichtheid_inwoners_per_km2">2012</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'buurten2011_bevolkingsdichtheid_inwoners_per_km2')}" name="buurten2011_bevolkingsdichtheid_inwoners_per_km2">2011</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'buurten2010_bevolkingsdichtheid_inwoners_per_km2')}" name="buurten2010_bevolkingsdichtheid_inwoners_per_km2">2010</a> | <a href="${fn:replace(fn:escapeXml(adreslink), 'cID', 'buurten2009_bevolkingsdichtheid_inwoners_per_km2')}" name="buurten2009_bevolkingsdichtheid_inwoners_per_km2">2009</a></li>
														</ul>
													</li>
