...
OverviewMap = OpenLayers.Class(OpenLayers.Control.OverviewMap, {
	...
	draw : function() {
		...
		btn.innerHTML = '<span>'+OpenLayers.i18n('KEY_TOGGLE_OVERVIEW_ON')+'</span><img src="img/maximize.png" alt=""/>';
		btn.name = 'tonen';
		this.maximizeDiv = btn;
		this.maximizeDiv.style.display = 'none';
		this.maximizeDiv.className = this.displayClass + 'MaximizeButton overviewMapButton olButton hasTooltip';
		this.div.appendChild(this.maximizeDiv);

		// minimize button
		btn = document.createElement("button");
		btn.innerHTML = '<span>'+OpenLayers.i18n('KEY_TOGGLE_OVERVIEW_OFF')+'</span><img src="img/minimize.png" alt=""/>';
		btn.name = 'verbergen';
		this.minimizeDiv = btn;
		this.minimizeDiv.style.display = 'none';
		this.minimizeDiv.className = this.displayClass + 'MinimizeButton overviewMapButton olButton hasTooltip';
